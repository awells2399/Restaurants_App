package com.example.restaurantsapp.restaurants.data.di

import android.content.Context
import androidx.room.Room
import com.example.restaurantsapp.restaurants.data.local.RestaurantsDao
import com.example.restaurantsapp.restaurants.data.local.RestaurantsDb
...
object RestaurantsModule {
    ...
    fun provideRetrofit(): Retrofit {
        return Retrofit.Builder()
            ...
            .baseUrl("https://restaurantsapp-cb673-default-rtdb.firebaseio.com/")
            .build()
    }
